...
//Encabezado tabla
function TableProcessHead(props) {
...
//Barra de opciones
function TableProcessToolbar(props) {
...
export default function TableProcess() {
  ...
  const [orderBy, setOrderBy] = React.useState('nombre_producto');
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        ...
                        {/* Contenido de la tabla */}
                          ...
                          <TableCell align="left">{row.cantidad_procesos}</TableCell>
