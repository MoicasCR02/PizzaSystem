  ...
  return (
    <TableHead>
      <TableRow>
        <TableCell>
          <Tooltip title="Crear">
            <IconButton component={Link} to="/products/crear/">
              <AddIcon />
            </IconButton>
          </Tooltip>
        </TableCell>
...
//Barra de opciones
function TableProductsToolbar(props) {
  const { numSelected } = props;
  const { idSelected } = props;
  const navigate = useNavigate();
  const update = () => {
    return navigate(`/products/update/${idSelected}`);
  };
  return (
    <Toolbar
      sx={{
...
TableProductsToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
