...
export function CreateUser() {
  ...
  const loginSchema = yup.object({
    ...
    password: yup
      ...
      .max(50, 'El password no debe exceder 50 caracteres')
      .matches(
    ...
    telefono: yup
      ...
      .matches(
        /^(\+?[\d\s]{7,15})$/,
        'El teléfono debe ser un número válido con entre 7 y 15 dígitos'
      ),
    
    id_rol: yup
      .number()
      .typeError('El rol es requerido y debe ser un número')
